...
@Configuration
@MapperScan(basePackages = "lol.cicco.mapper.test2", sqlSessionTemplateRef  = "test2SqlSessionTemplate")
public class DataSource2Config {
    ...
    @Bean(name = "tx2")
    public DataSourceTransactionManager tx2(@Qualifier("test2DataSource") DataSource dataSource) {
